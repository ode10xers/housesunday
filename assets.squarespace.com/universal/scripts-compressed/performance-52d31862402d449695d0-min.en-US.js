...
(self.webpackChunkextract_css = self.webpackChunkextract_css || []).push([
  [52730],
  {
    ...
    696208: function (P, w, _) {
      ...
      function j(d) {
        for (var l = 1; l < arguments.length; l++) {
          ...
          typeof Object.getOwnPropertySymbols == 'function' &&
            (R = R.concat(
              Object.getOwnPropertySymbols(E).filter(function (M) {
      ...
      function Q() {
        var d = h.websiteSettings,
          l = d === void 0 ? {} : d;
        return { ampEnabled: !!l.ampEnabled };
      }
      function K() {
        var d = h.collection,
          l = d === void 0 ? {} : d;
        return { collectionType: l.type || -1 };
      }
      function Y() {
        return h.hasOwnProperty('templateVersion')
          ? h.templateVersion.replace('.', '_')
          : null;
      }
      function p(d) {
        var l,
          E = (l = q[d]) !== null && l !== void 0 ? l : 0;
      ...
      function y(d) {
        var l = I(),
          ...
          R = {
            appName:
              E || 'v'.concat(d, '-').concat(l ? 'config' : 'user-sites'),
            context: j({}, k(), b(), Q(), K()),
            captureException: function (ce, se) {
              (0, N.withScope)(function (ne) {
                ne.setTag('product_area', 'rum-collector'),
                  se !== void 0 && ne.setExtra('extras', se),
                  (0, N.captureException)(ce);
              });
            },
          };
        if (l) {
          var M = h.website.siteStatus.value === S.default.INTERNAL,
            ...
            te = J.createdOn,
            ue = J.id;
          (R.context.isInternal = M),
            (R.context.createdOn = te),
            (R.context.memberId = ue);
        }
        return (
          p(R.appName) &&
            (R.serviceURL =
    ...
    163795: function (P, w) {
      ...
      function _(p, y) {
        for (var m in y)
          Object.defineProperty(p, m, { enumerable: !0, get: y[m] });
      }
      _(w, {
      ...
      var x = function () {},
        ...
        k = function (p) {
          return function (y) {
            for (
              var m = arguments.length, d = new Array(m > 1 ? m - 1 : 0), l = 1;
              l < m;
              l++
            )
              d[l - 1] = arguments[l];
            ...
            return (
              (E = console).log.apply(
                E,
                ['[Sentry]['.concat(p, '] ').concat(y)].concat(N(d))
              ),
      ...
      window.SQUARESPACE_SENTRY
        ? ((K = !0),
          (j = window.SQUARESPACE_SENTRY.addBreadcrumb),
          (q = window.SQUARESPACE_SENTRY.captureMessage),
          (h = window.SQUARESPACE_SENTRY.captureException),
          (U = window.SQUARESPACE_SENTRY.captureEvent),
          (V = window.SQUARESPACE_SENTRY.configureScope),
          (L = window.SQUARESPACE_SENTRY.withScope),
          (I = window.SQUARESPACE_SENTRY.getCurrentScope))
        : (console.warn(
            'SENTRY WAS __NOT__ INITIALIZED. Logs will be forwarded to console instead.'
          ),
          (j = b ? Q : x),
          (q = k('captureMessage')),
          (h = k('captureException')),
          (U = k('captureEvent')),
          (I = Y),
          (V = x),
          (L = function () {
            for (var y = arguments.length, m = new Array(y), d = 0; d < y; d++)
              m[d] = arguments[d];
    ...
    769078: function (P) {
      ...
      var Q = Object.defineProperty,
        ...
        l = function (t) {
          return d(Q({}, '__esModule', { value: !0 }), t);
        },
        E,
        R = y({
      ...
      var Wt = '/api/1/performance/records',
        ...
        en = function (t) {
          document.readyState === 'complete'
            ...
            : window.addEventListener('pageshow', t, { once: !0 });
        },
        tn = function () {
          return Ee(en);
        },
              ...
              switch (i.label) {
                ...
                case 1:
                  return (
                    (n = i.sent()),
                    (r = n[e]),
                    typeof r != 'number' || r < 0 || r > 2147483647
                      ? [2]
                      : [2, Math.round(r)]
                  );
              }
        ...
        He = function (t) {
          return Promise.all([
            ...
            var n = L(e, 2),
              r = n[0],
              i = n[1];
            t({ domainLookup: Se(r, i) });
          });
        },
        je = function (t) {
          return Fe('type').then(function (e) {
            t({ navigationTimingType: e });
          });
        },
        qe = function (t) {
          return rn().then(function (e) {
            t({ serverTiming: JSON.stringify(e) });
          });
        },
        Ve = function (t) {
          return Promise.all([W('connectEnd'), W('connectStart')]).then(
            function (e) {
              var n = L(e, 2),
                r = n[0],
                i = n[1];
              t({ tcpConnection: Se(r, i) });
            }
          );
        },
        Qe = function (t) {
          return Promise.all([
            W('connectEnd'),
            W('secureConnectionStart'),
          ]).then(function (e) {
            var n = L(e, 2),
              r = n[0],
              i = n[1];
            t({ tlsNegotiation: Se(r, i) });
          });
        },
        B,
        re,
        ...
        ae = function (e, n, r) {
          try {
            if (PerformanceObserver.supportedEntryTypes.includes(e)) {
              ...
              return (
                i.observe(Object.assign({ type: e, buffered: !0 }, r || {})), i
              );
            }
          } catch (a) {}
        },
        ...
        le = function (e) {
          document.visibilityState === 'hidden' &&
            Z > -1 &&
            ((Z = e.type === 'visibilitychange' ? e.timeStamp : 0), an());
        },
        Ze = function () {
          addEventListener('visibilitychange', le, !0),
            addEventListener('prerenderingchange', le, !0);
        },
        an = function () {
          removeEventListener('visibilitychange', le, !0),
            removeEventListener('prerenderingchange', le, !0);
        },
        $e = function () {
          return (
            Z < 0 &&
                  ...
                  u.forEach(function (s) {
                    s.name === 'first-contentful-paint' &&
                      ...
                      s.startTime < i.firstHiddenTime &&
                        ((a.value = Math.max(s.startTime - ze(), 0)),
                        a.entries.push(s),
                        r(!0)));
                  });
                });
              o &&
                ((r = H(e, a, et, n.reportAllChanges)),
                ie(function (u) {
                  (a = F('FCP')),
                    (r = H(e, a, et, n.reportAllChanges)),
                    Xe(function () {
                    ...
                    v.forEach(function (g) {
                      if (!g.hadRecentInput) {
                        var T = o[0],
                          A = o[o.length - 1];
                        a &&
                        g.startTime - A.startTime < 1e3 &&
                        g.startTime - T.startTime < 5e3
                          ? ((a += g.value), o.push(g))
                          : ((a = g.value), (o = [g]));
                      }
                    }),
            ...
            e.type == 'pointerdown'
              ? (function (r, i) {
                  var a = function () {
                    ...
                    u = function () {
                      removeEventListener('pointerup', a, oe),
                        removeEventListener('pointercancel', o, oe);
                    };
                  addEventListener('pointerup', a, oe),
                    addEventListener('pointercancel', o, oe);
                })(n, e)
              : rt(n, e);
          }
        },
          ...
          (n = n || {}),
            Ae(function () {
              var r,
                ...
                a = F('FID'),
                o = function (v) {
                  v.startTime < i.firstHiddenTime &&
                    ((a.value = v.processingStart - v.startTime),
                    a.entries.push(v),
                    r(!0));
                },
                u = function (v) {
        ...
        fn = function (e) {
          e.forEach(function (n) {
            n.interactionId &&
              ((Ce = Math.min(Ce, n.interactionId)),
              (ve = Math.max(ve, n.interactionId)),
              (ut = ve ? (ve - Ce) / 7 + 1 : 0));
          });
        },
        ct = function () {
            ...
            Ae(function () {
              ...
              var i,
                ...
                o = function (c) {
                  ...
                  var v,
                    g =
                      ((v = Math.min(O.length - 1, Math.floor(dt() / 50))),
                      O[v]);
                  g &&
                    g.latency !== a.value &&
                    ((a.value = g.latency), (a.entries = g.entries), i());
                },
                u = ae('event', o, {
                  durationThreshold:
                    (r = n.durationThreshold) !== null && r !== void 0 ? r : 40,
                });
              (i = H(e, a, st, n.reportAllChanges)),
                u &&
        ...
        pe = function (e) {
          document.visibilityState === 'hidden' &&
            $ > -1 &&
            (($ = e.type === 'visibilitychange' ? e.timeStamp : 0), En());
        },
        wt = function () {
          addEventListener('visibilitychange', pe, !0),
            addEventListener('prerenderingchange', pe, !0);
        },
        En = function () {
          removeEventListener('visibilitychange', pe, !0),
            removeEventListener('prerenderingchange', pe, !0);
        },
        _n = function () {
          return (
            $ < 0 &&
              ...
              Sn(function () {
                var a,
                  ...
                  s = function (T) {
                    var A = T[T.length - 1];
                    A &&
                      A.startTime < o.firstHiddenTime &&
                      ((u.value = Math.max(A.startTime - mt(), 0)),
                      (u.entries = [A]),
                      a());
                  },
                  ...
                  ['keydown', 'click'].forEach(function (g) {
                    ...
                    pt(function (g) {
                      (u = gt('LCP')),
                        (a = ht(r, u, Et, i.reportAllChanges)),
                        hn(function () {
                          (u.value = performance.now() - g.timeStamp),
                            (Pe[u.id] = !0),
                            a(!0);
                        });
                    });
              ...
              if (i.entries.length) {
                ...
                if (a) {
                  var o = a.activationStart || 0,
                    ...
                    v = Math.max(
                      c,
                      s ? (s.requestStart || s.startTime) - o : 0
                    ),
                  ...
                  return (
                    u.url && (A.url = u.url),
                    s && (A.lcpResourceEntry = s),
                    void (i.attribution = A)
                  );
                }
              }
              i.attribution = {
        ...
        _t = function (t) {
          ...
          var r = t,
            i = -1;
          do (r = r.previousElementSibling), (i += 1);
          while (r !== null);
          n += '[' + i + ']';
          var a =
            (e = t.classList.value) === null || e === void 0
              ? void 0
              : e.trim().replace(/\s+/g, '.');
          return a && (n += '.' + a), n;
        },
        ...
        Cn = function (t) {
          var e,
            n =
              (e = t.attribution.lcpEntry) === null || e === void 0
                ? void 0
                : e.element;
          return {
        ...
        bt = function (t) {
          on(
            function (e) {
              t({ cumulativeLayoutShift: e.value });
            },
            { reportAllChanges: !0 }
          );
        },
        Tt = function (t) {
          tt(function (e) {
            t({ firstContentfulPaint: Math.round(e.value) });
          });
        },
        At = function (t) {
          sn(function (e) {
            t({ firstInputDelay: Math.round(e.value) });
          });
        },
        Ct = function (t) {
          ln(function (e) {
            t({ interactionToNextPaint: Math.round(e.value) });
          });
        },
        Lt = function (t) {
          bn(function (e) {
            ...
            var n = S(function (r) {
              ...
              return b(this, function (c) {
                switch (c.label) {
                  ...
                  case 1:
                    return (
                      e.apply(void 0, [z.apply(void 0, i.concat([c.sent()]))]),
                      [3, 3]
                    );
                  case 2:
                    return (
                      ...
                      (s = window) === null ||
                        s === void 0 ||
                        (u = s.SQUARESPACE_SENTRY) === null ||
                        u === void 0 ||
                        (o = u.captureException) === null ||
                        o === void 0 ||
                        o.call(u, a),
                      [3, 3]
                    );
                ...
                switch (u.label) {
                  ...
                  case 2:
                    return (
                      ...
                      (o = window) === null ||
                        o === void 0 ||
                        (a = o.SQUARESPACE_SENTRY) === null ||
                        a === void 0 ||
                        (i = a.captureException) === null ||
                        i === void 0 ||
                        i.call(a, r),
                      [3, 3]
                    );
        ...
        Pt = function () {
          ...
          return {
            ...
            networkInformationType:
              (t = navigator.connection) === null || t === void 0
                ? void 0
                : t.type,
            prefersContrast: Nn(),
        ...
        On = function (t) {
          var e = Pt(),
            ...
            r = function (a) {
              ...
              ['INPUT', 'TEXTAREA'].includes(
                (o = a.target) === null || o === void 0 ? void 0 : o.tagName
              ) ||
                !zt.includes(a.key) ||
                ((e.keyboardUsage = !0),
          ...
          var i = function () {
            document.visibilityState === 'hidden' &&
              (n(),
              document.removeEventListener('keydown', r),
              document.removeEventListener(fe, i));
          };
      ...
      function Ot() {
        ...
        try {
          ...
          t.observe({ entryTypes: ['mark'] }), t.disconnect();
        } catch (e) {
          return !1;
        }
        return !0;
      ...
      function It() {
        var t;
        return (
          typeof ((t = window.navigator) === null || t === void 0
            ? void 0
            : t.sendBeacon) == 'function' &&
          !Zt.test(window.navigator.userAgent)
        );
      }
      var me = function (t) {
        var e = Number(t);
      ...
      function Mn() {
        ...
        return {
          ...
          marketingId: Nt(Xt),
          memberId:
            (r = window.Static) === null ||
            r === void 0 ||
            (n = r.SQUARESPACE_CONTEXT) === null ||
            n === void 0 ||
            (e = n.authenticatedAccount) === null ||
            e === void 0
              ? void 0
              : e.id,
          version: $t,
          ...
          effectiveType:
            (a = navigator.connection) === null || a === void 0
              ? void 0
              : a.effectiveType,
          rtt: me(
            (o = navigator.connection) === null || o === void 0 ? void 0 : o.rtt
          ),
          saveData: Number(
            ((u = navigator.connection) === null || u === void 0
              ? void 0
              : u.saveData) || 0
          ),
      ...
      var Dn = (function () {
        ...
        Bn = function (t) {
          return t.hasAttribute('data-loader')
            ? 2
        ...
        Fn = function (t, e) {
          if (t.hasAttribute('data-image-resolution')) {
            var n;
            return Number(
              (n = t.getAttribute('data-image-resolution')) === null ||
                n === void 0
                ? void 0
                : n.replace('w', '')
            );
        ...
        jn = function (t) {
          if (N(t, HTMLImageElement)) {
            var e = t.naturalHeight,
              ...
              r = t.width,
              i = t.height;
            return { naturalHeight: e, naturalWidth: n, width: r, height: i };
          }
          var a = t.getBoundingClientRect(),
            o = Math.floor(a.width),
            u = Math.floor(a.height);
          return { naturalHeight: u, naturalWidth: o };
        },
        qn = (function () {
          var t = S(function (e, n) {
            ...
            return b(this, function (dr) {
              (r = Fn(n, e.name)),
                (i = Bn(n)),
                (a = n.getAttribute('data-loader')),
                (o = n.getAttribute('elementtiming')),
                (u = e.toJSON()),
                (s = u.serverTiming),
                (c = u.workerTiming),
                (v = U(u, ['serverTiming', 'workerTiming'])),
                (g = !0),
                (T = !1),
                (A = void 0);
              try {
                for (
                  D = Object.entries(v)[Symbol.iterator]();
                  !(g = (qt = D.next()).done);
                  g = !0
                )
                  (Me = L(qt.value, 2)),
                    (Vt = Me[0]),
                    (De = Me[1]),
                    typeof De == 'number' && (v[Vt] = Math.floor(De));
              } catch (xe) {
                (T = !0), (A = xe);
              } finally {
                try {
                  ...
                  return (
                    ...
                    !(
                      ...
                      : ((i = n.name.replace(/\?.*/, '')),
                        ...
                        document
                          .querySelectorAll(
                            'picture > source[srcset*="'.concat(n.name, '"]')
                          )
                          .forEach(function (s) {
        ...
        Mt = (function () {
          var t = S(function (e) {
            ...
            return b(this, function (i) {
              return Ot()
                ? ((n = function (a) {
                    return Vn({ resource: a, deliverMetrics: e });
                  }),
                  performance.getEntriesByType('resource').forEach(n),
                  (r = new PerformanceObserver(function (a) {
        ...
        Oe = function (t) {
          var e = t.spanName,
            ...
            a = i === void 0 ? {} : i;
          G === void 0 && (G = new Map());
          var o = n.startSpan(e, { startTime: r });
        ...
        xt = function (t) {
          var e, n;
          typeof ((n = window) === null ||
          n === void 0 ||
          (e = n.SQUARESPACE_SENTRY) === null ||
          e === void 0
            ? void 0
            : e.captureException) == 'function'
            ? window.SQUARESPACE_SENTRY.captureException(t)
            : console.warn(
                '@sqs/rum-collector: user timing exception: '.concat(t)
              );
        };
      function Qn(t) {
        var e =
        ...
        try {
          ...
          if (e.tracer !== void 0) {
            var i = L(
                window.performance.getEntriesByName(n, 'mark').slice(-1),
                1
              ),
              a = i[0];
            Oe({
      ...
      function Yn(t) {
        ...
        try {
          if (!(Ut() && Wn())) return;
          var n = ee + t,
            r = { detail: e.detail, duration: e.duration };
          if (
            (e.start === void 0
              ? window.performance.getEntriesByName(n, 'mark').length > 0 &&
                (r.start = n)
              : typeof e.start == 'string'
              ? (r.start = ee + e.start)
              : (r.start = e.start),
            (r.end = typeof e.end == 'string' ? ee + e.end : e.end),
            e.requireStart && typeof r.start != 'string')
          )
            return;
          if (e.tracer !== void 0) {
            var i = h({ measureName: n }, e.spanAttributes);
            if (typeof r.start == 'number')
              Oe({ spanName: n, tracer: e.tracer, startTime: r.start }),
                Dt({ spanName: n, spanAttributes: i });
            else {
              var a;
              if (
                window.performance.getEntriesByName(
                  (a = r.start) !== null && a !== void 0 ? a : n,
                  'mark'
                ).length === 0
              ) {
                var o;
              ...
              switch (i.label) {
                ...
                case 1:
                  ...
                  try {
                    ...
                    e.captureException(a, { pageLoadId: n, parsedOptions: e });
                  }
                  return [2];
              }
            });
      ...
      var ir = {
        ...
        ar = function () {
          var t = /^qa\d+.sqsp.net/g,
            ...
            r = window.location.hostname.substr(
        ...
        or = function (t) {
          var e =
            arguments.length > 1 && arguments[1] !== void 0
              ...
              : ar();
          return new t(
            { customSchemaName: 'Performance', sourceEnvironment: e },
            ir
          );
        },
        jt = Object.freeze({
                    ...
                    Ne(function (i) {
                      Object.entries(i).forEach(function (a) {
                        var o = L(a, 2),
                          u = o[0],
                          s = o[1];
                        Object.prototype.hasOwnProperty.call(jt, u) &&
                          (n[jt[u]] = s);
                      });
                    }),
                    [4, Promise.race([ke(6e4), Be()])]
